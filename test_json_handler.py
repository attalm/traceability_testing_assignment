...
@requirement("REQ-101")
def test_read_json(json_handler, updated_file):
    """
...
@requirement("REQ-102")
def test_write_json(json_handler, updated_file):
    """
...
@requirement("REQ-104")
def test_update_json(json_handler, another_file):
    """
    Test updating JSON data in a file.
    """
    data = {"test": "data"}
    json_handler.write_json(data, another_file)
    json_handler.update_json("test", "new data", another_file)
    updated_data = json_handler.read_json(another_file)
